	...
	/* function selectWrite(){
		...
		function selectWrite() {
			...
			let bno = document.querySelector("input[name='bno']").value;
			  ...
			  if (bno > 0) {
			   frm.action = "/board/editAction?bno=" + bno;
			  } else if (bno === '') {
...
<body>
	...
	<c:set value="${param.bno }" var="bno"></c:set>
	...
	<div class="bg-light p-5 rounded">
		...
		<a class="btn btn-lg btn-primary" href="../board/list_bs"
			role="button">목록보기 &raquo;</a>
	</div>
	...
	<div class="list-group w-auto">
		...
		<form method ="post" onsubmit="selectWrite()" name="frm">
			...
			<div class="mb-3">
				...
				<textarea class="form-control" id="writer" name="writer" rows="3">${board.writer }</textarea>
			</div>
			<div class="d-grid gap-2 d-md-flex justify-content-md-end">

				<!-- 만약 bno 가 비어있지 않으면 수정하기.. -->
				<c:if test="${not empty bno}" var="res">
